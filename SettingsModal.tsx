...
const themeGroups: Record<string, ThemeName[]> = {
    "Showcase Themes": ['rgb', 'black-gold', 'night-sky', 'cherry-blossom'],
        ...
        <div className="mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <button
                    ...
                    className="p-4 rounded-md border transition-all duration-200 flex flex-col items-center justify-center text-center hover:scale-105 active:scale-100"
                    style={{
                        backgroundColor: 'var(--bg-secondary)',
                        color: layout === 'modern' ? 'var(--text-accent)' : 'var(--text-primary)',
                        borderColor: 'var(--border-primary)',
                        boxShadow: layout === 'modern' ? `0 0 10px -1px var(--text-accent)` : 'none',
                        transform: layout === 'modern' ? 'scale(1.03)' : 'scale(1)',
                    }}
                ...
                <button
                    ...
                    style={{
                        backgroundColor: 'var(--bg-secondary)',
                        color: layout === 'standard' ? 'var(--text-accent)' : 'var(--text-primary)',
                        borderColor: 'var(--border-primary)',
                        boxShadow: layout === 'standard' ? `0 0 10px -1px var(--text-accent)` : 'none',
                        transform: layout === 'standard' ? 'scale(1.03)' : 'scale(1)',
                    }}
                ...
                <button
                    ...
                    style={{
                        backgroundColor: 'var(--bg-secondary)',
                        color: layout === 'focused' ? 'var(--text-accent)' : 'var(--text-primary)',
                        borderColor: 'var(--border-primary)',
                        boxShadow: layout === 'focused' ? `0 0 10px -1px var(--text-accent)` : 'none',
                        transform: layout === 'focused' ? 'scale(1.03)' : 'scale(1)',
                    }}
