...
export const CommandPalette: React.FC<CommandPaletteProps> = ({ onClose, onSetView }) => {
  ...
  const commands: Command[] = useMemo(() => {
    ...
    const navigationCommands: Command[] = [
        ...
        { id: 'goto-ai-photo-editor', name: 'Go to AI Photo Editor', section: 'Navigation', icon: <PaintBrushIcon className="w-5 h-5"/>, action: () => onSetView(AppView.AIPhotoEditor), keywords: 'edit photo image retouch pixshop' },
